...
**Decider name and availability:** Jamie, full-week availability for 2026-05-26 through 2026-05-30; no calendar conflicts in load-bearing windows (Mon AM, Wed AM, Fri PM).
...
The team meets all eight canonical readiness criteria. Recruiting is the only watch item: it must start within 24 hours to hit the 2026-05-23 recruiting deadline.
...
| 8. Sprint output has a path forward | PASS | Decider review by 16:30 Friday; build (6-week MVP starting June 2), iterate (re-sprint), or pivot to Red Bookstore Mode |
...
The single watch item is recruiting. Riley needs to start recruiting within 24 hours (by 2026-05-16 EOD) to hit the canonical 7-day lead before 2026-05-23 (last day to confirm Friday slots). A UserInterviews panel is the safety net if the Discord channel underdelivers; Riley has used the panel before with a 65% confirm-to-show rate, meaning the team should target 6 confirmed slots (1 buffer) to land 5 actual customers Friday.
...
| Recruiting deadline | 2026-05-23 (Friday before sprint week; confirm all 5+1 customers and send calendar invites) |
...
1. **Activate recruiting** (Riley owns; deadline: 2026-05-16 EOD). Post Discord outreach plus open UserInterviews panel. Confirm 6 slots by 2026-05-23.
2. **Pre-load Miro board with Design Sprint week template** (Alex owns; deadline: 2026-05-22 EOD). Use the canonical AJ and Smart 5-day Miro template; pre-fill Brainshelf challenge text and FS context in the Day 1 frame.
3. **Print the Founding Hypothesis plus assumption scorecard** (Jamie owns; deadline: 2026-05-25 EOD). For wall reference Monday morning during Map and Target.
4. **Block calendars and arrange non-sprint coverage** (whole team owns; deadline: 2026-05-22 EOD). No Slack, no email during sprint hours (09:00-17:00 PT) all 5 days. Sam arranges on-call coverage; Jamie reroutes investor pings to async-only.
5. **Confirm Figma file shape** (Alex owns; deadline: 2026-05-25 EOD). Empty Figma file in Brainshelf workspace, named "DS-2026-05-26-prototype", shared with all 4 team members in edit mode.
6. **Final Friday logistics dry-run** (Riley owns; deadline: 2026-05-28 EOD Thursday). Test Zoom + Figma screen-share with one team-member acting as customer; confirm prototype-record settings; confirm interview script will be loaded.
...
| Riley | Customer expert + interviewer | All 5 days; owns recruiting through 2026-05-23 and Fri interview moderation |
...
- [x] Jamie agrees the output should be a Friday scorecard plus a Decider call by 16:30 Friday with an explicit build / iterate / pivot to Red Bookstore Mode / stop decision.
...
**Recruiting authorized; sprint locked for 2026-05-26 through 2026-05-30.**
