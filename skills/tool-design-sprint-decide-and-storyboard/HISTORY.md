...
- Facilitation format: design-sprint (see `metadata.frameworks`)
- Day: Wednesday (Day 3, decide and storyboard); 5-day Design Sprint context
- Timebox: 240 minutes; roles: facilitator, Decider
