...
**v2.18.0 content-skill additions (12 samples):**
...
**v2.26.0 workflow-builder addition (3 samples):**

- **3 utility-pm-workflow-builder samples** - 1 per thread (storevine campaign-launch workflow, brainshelf digest-experiment loop, workbench enterprise-rollout review)

**v2.28.0 foundation addition (18 samples):**

- **6 per thread x foundation-stakeholder-briefings** - master document plus audience-tailored briefings, one per stakeholder lens, each a traceable projection of the master

**v2.29.0 foundation addition (3 samples):**
...
**AI conditional-section follow-on (1 sample):**

- **1 measure-instrumentation-spec sample** - Brainshelf Resurface explanation diagnostics, demonstrating Model Trace Capture and planned claim-level QA coverage

75 + 11 + 12 + 3 + 7 + 15 + 3 + 21 + 21 + 3 + 12 + 3 + 3 + 18 + 3 + 2 + 1 + 1 = 214 itemized, which matches the on-disk corpus exactly. If you add a sample, update the headline total, its release cohort, and this line together.
...
| Foundation | stakeholder-briefings | Master document plus audience-tailored briefings, one per stakeholder lens, each a traceable projection of the master | [prd](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-prd.md), [launch](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-launch.md), [experiment](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-experiment.md), [strategy](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-strategy.md), [retro](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-retro.md), [discovery](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-discovery.md) | [prd](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-prd.md), [experiment](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-experiment.md), [launch](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-launch.md), [discovery](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-discovery.md), [pivot](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-pivot.md), [rawnotes](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-rawnotes.md) | [prd](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-prd.md), [strategy](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-strategy.md), [experiment](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-experiment.md), [compliance](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-compliance.md), [launch](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-launch.md), [discovery](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-discovery.md) |
| Foundation | build-risk-review | Fast pre-build or feature-scope risk gate: the single biggest risk, a graded evidence ledger, a verdict (build small / validate first / pivot first / don't build yet), and a no-code next step | [storevine](foundation-build-risk-review/sample_foundation-build-risk-review_storevine_bulk-price-update.md) | [brainshelf](foundation-build-risk-review/sample_foundation-build-risk-review_brainshelf_ai-auto-tagging.md) | [workbench](foundation-build-risk-review/sample_foundation-build-risk-review_workbench_enterprise-knowledge-base.md) |
...
| Discover | journey-map | Customer journey map with stages, touchpoints, emotional curve, pain points, and moments of truth | [storevine](discover-journey-map/sample_discover-journey-map_storevine_procure-to-renew.md) | [brainshelf](discover-journey-map/sample_discover-journey-map_brainshelf_first-subscription.md) | [workbench](discover-journey-map/sample_discover-journey-map_workbench_dev-onboarding.md) |
| Discover | market-sizing | Multi-framework market sizing (TAM/SAM/SOM) with convergence/divergence synthesis and confidence labels | [storevine](discover-market-sizing/sample_discover-market-sizing_storevine_inventory-forecasting.md) | [brainshelf](discover-market-sizing/sample_discover-market-sizing_brainshelf_book-curation.md) | [workbench](discover-market-sizing/sample_discover-market-sizing_workbench_devex-tooling.md) |
...
| Define | prioritization-framework | Multi-framework prioritization (RICE/ICE/MoSCoW/Weighted/Kano) with cross-framework comparison and recommendation | [storevine](define-prioritization-framework/sample_define-prioritization-framework_storevine_mvp-scope.md) | [brainshelf](define-prioritization-framework/sample_define-prioritization-framework_brainshelf_q3-features.md) | [workbench](define-prioritization-framework/sample_define-prioritization-framework_workbench_hypothesis-triage.md) |
...
| Measure | survey-analysis | Survey analysis with persona segmentation, hypothesis validation, thematic clustering, and limitation warnings | [storevine](measure-survey-analysis/sample_measure-survey-analysis_storevine_feature-validation.md) | [brainshelf](measure-survey-analysis/sample_measure-survey-analysis_brainshelf_nps-pulse.md) | [workbench](measure-survey-analysis/sample_measure-survey-analysis_workbench_devex-pulse.md) |
...
| Foundation | [stakeholder-briefings - prd](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-prd.md) | Campaigns PRD fanned into a master plus per-lens briefings (eng, design, GTM, exec) |
| Foundation | [stakeholder-briefings - launch](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-launch.md) | Campaigns launch update fanned into audience-tailored briefings from one master |
| Foundation | [stakeholder-briefings - experiment](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-experiment.md) | Campaigns experiment readout projected into per-stakeholder briefings |
| Foundation | [stakeholder-briefings - strategy](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-strategy.md) | Campaigns strategy memo fanned into lens-specific briefings |
| Foundation | [stakeholder-briefings - retro](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-retro.md) | Campaigns retro source fanned into a master plus audience briefings |
| Foundation | [stakeholder-briefings - discovery](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_storevine_campaigns-discovery.md) | Campaigns discovery notes projected into per-stakeholder briefings |
| Foundation | [build-risk-review](foundation-build-risk-review/sample_foundation-build-risk-review_storevine_bulk-price-update.md) | Native bulk price-update tool for mid-market merchants (verdict: Build small) |
...
| Foundation | [stakeholder-briefings - prd](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-prd.md) | Resurface PRD fanned into a master plus per-lens briefings from one source |
| Foundation | [stakeholder-briefings - experiment](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-experiment.md) | Resurface experiment readout projected into audience-tailored briefings |
| Foundation | [stakeholder-briefings - launch](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-launch.md) | Resurface launch update fanned into per-stakeholder briefings |
| Foundation | [stakeholder-briefings - discovery](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-discovery.md) | Resurface discovery notes fanned into lens-specific briefings |
| Foundation | [stakeholder-briefings - pivot](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-pivot.md) | Resurface pivot decision projected into audience briefings from one master |
| Foundation | [stakeholder-briefings - rawnotes](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_brainshelf_resurface-rawnotes.md) | Resurface raw notes fanned into a master plus per-lens briefings |
| Foundation | [build-risk-review](foundation-build-risk-review/sample_foundation-build-risk-review_brainshelf_ai-auto-tagging.md) | AI auto-tagging new bet, target user and willingness to pay unproven (verdict: Don't build yet) |
...
| Measure | [model traces](measure-instrumentation-spec/sample_measure-instrumentation-spec_brainshelf_resurface-model-traces.md) | Generated Resurface explanation diagnostics: minimization, fail-closed capture, and planned QA coverage |
...
| Foundation | [stakeholder-briefings - prd](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-prd.md) | Blueprints PRD fanned into a master plus per-lens briefings (eng, legal, exec, CS) |
| Foundation | [stakeholder-briefings - strategy](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-strategy.md) | Blueprints strategy memo projected into audience-tailored briefings |
| Foundation | [stakeholder-briefings - experiment](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-experiment.md) | Blueprints experiment readout fanned into per-stakeholder briefings |
| Foundation | [stakeholder-briefings - compliance](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-compliance.md) | Blueprints compliance source fanned into lens-specific briefings |
| Foundation | [stakeholder-briefings - launch](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-launch.md) | Blueprints launch update projected into audience briefings from one master |
| Foundation | [stakeholder-briefings - discovery](foundation-stakeholder-briefings/sample_foundation-stakeholder-briefings_workbench_blueprints-discovery.md) | Blueprints discovery notes fanned into a master plus per-lens briefings |
| Foundation | [build-risk-review](foundation-build-risk-review/sample_foundation-build-risk-review_workbench_enterprise-knowledge-base.md) | Broad enterprise AI knowledge-base bet, wedge too crowded (verdict: Pivot first) |
