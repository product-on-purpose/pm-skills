...
All 68 skills are available immediately. Invoke any by name, for example `/pm-skills:deliver-prd`. Already on the old `pm-skills-marketplace`? It keeps working; see [Setup by Platform](https://product-on-purpose.github.io/pm-skills/getting-started/platforms/) to switch homes.
...
More detail: see the [full getting-started guide](https://product-on-purpose.github.io/pm-skills/getting-started/) for the long-form walkthrough.
