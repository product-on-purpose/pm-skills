...
- **4 dispatch skills VALIDATED on Codex CLI 2026-05-17 per Option A** of master plan D30. GATE B (3 non-conductor dispatch skills) and GATE C (conductor dispatch sub-spike including chain composition via "reference + execute inline" pattern) both PASSED on Codex CLI 0.128.0. Context budget held through the conductor's 6-gate dry-run flow. Layered envelope output produced consistently. Refusal protocols + no-bypass discipline worked. All 4 dispatch skills RATIFIED for v2.16.0 ship; EXPERIMENTAL caveats removed from SKILL.md files. Cross-client validation evidence at [`docs/internal/release-plans/v2.16.0/gate-test-results_2026-05-17_codex.md`](docs/internal/release-plans/v2.16.0/gate-test-results_2026-05-17_codex.md). Additional clients (Cursor, Windsurf, Copilot, Gemini CLI) may also work but have not been independently validated yet; maintainer-driven second-client validation deferred to v2.17 if useful.
