...
pm-skills supports two parallel install paths for Claude Code, plus a third path for tools outside the Claude Code ecosystem. All three are working as of v2.14.0; pick whichever fits your client and workflow.
