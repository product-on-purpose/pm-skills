...
**Status:** v2.15.2 SHIPPED 2026-05-17 + v2.15.x CYCLE CLOSED (v2.15.0 `a108301` -> v2.15.1 `6f89439` -> v2.15.2 closeout). v2.16.0 is now ACTIVE (5 sub-plans + 4 sub-agent spec docs authored; 66 tasks, 14-22 sessions estimated; theme: Active Orchestration + Doc-Stack Modernization).
