...
<!-- pmskills:version-badge:start (generated by scripts/gen-derived-surfaces.mjs; edit .claude-plugin/plugin.json, not this block) -->
    <img src="https://img.shields.io/badge/version-2.32.0-blue.svg?style=flat-square" alt="Version">
...
|                     |                                                                                           |
| ------------------- | ----------------------------------------------------------------------------------------- |
| **Current version** | [v2.32.0](https://github.com/product-on-purpose/pm-skills/releases/tag/v2.32.0)           |
