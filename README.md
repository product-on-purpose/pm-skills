...
- ✅ **60 Production-Ready Skills** covering the complete product lifecycle (27 phase skills + 8 foundation skills + 10 utility skills + 15 tool skills for sprint methodologies)
...
**Fastest path:** Install all 60 skills into your agent with one command, using the open [`skills` CLI](https://github.com/vercel-labs/skills):
...
After install, all 60 skills and 67 commands resolve from any directory. Slash commands like `/prd`, `/opportunity-tree`, `/agenda`, `/okr-writer`, etc. work out of the box.
...
Installs all 60 skills into your agent's default skills directory. Slash commands (`/prd`, `/hypothesis`, `/user-stories`, etc.) become available immediately. No clone, no sync helper.
...
All 60 skills are available as `/skill-name` commands. See [commands/](commands/) for the full list.
...
Open the folder in Cursor or Windsurf. The AI assistant will automatically discover and can use all 60 skills.
...
This clones pm-skills, scans the `skills/` directory, and installs all 60 skills into your agent's default skills directory. Supported agents include Claude Code, Cursor, GitHub Copilot, Cline, and others. Discoverable via the [skills.sh directory](https://skills.sh/product-on-purpose/pm-skills).
...
PM-Skills covers the complete product lifecycle using the **Triple Diamond** framework (27 phase skills) plus foundation and utility capabilities:
...
| **[Triple Diamond](_workflows/triple-diamond.md)**   | Major initiatives | Full 27 phase-skill flow across 6 phases                                |
...
```
Complete product development across all 6 phases and 27 phase skills
```
...
```
pm-skills/
├── skills/                     # 60 PM skills (27 phase + 8 foundation + 10 utility + 15 tool)
...
<details>
<summary><strong>Do I need to install all 60 skills?</strong></summary>
...
**pm-skills** (this repo) is the source skill library with all 60 PM skills as markdown files. It's best for Claude Code slash commands, file browsing, and customization.
