...
### Option 2: Claude Code (Direct Use)
...
### Option 4: Via openskills CLI

> ⚠️ **Note:** openskills has a [known issue](https://github.com/numman-ali/openskills/issues/48) with nested skill directories. Use Git clone until resolved.
...
**Output:** A comprehensive PRD with:
- Problem statement and user pain points
- Success metrics and KPIs
- User stories with acceptance criteria
- Scope (in/out) and dependencies
- Technical considerations and constraints
- Launch checklist and rollout plan

*All in professional, production-ready format—in seconds.*
