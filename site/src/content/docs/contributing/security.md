---
title: Security
description: "Security policy for pm-skills: what ships, what runs at install, the hook opt-in model, the supply-chain posture, how to report vulnerabilities, supported versions, and the static-site CVE exemption position documented in docs/internal/dependency-policy.md."
---
...
See [Provenance and Trust](../reference/provenance.md) for the same posture restated for readers who never open this repository.
