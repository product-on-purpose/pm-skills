...
Full details in root [`CHANGELOG.md`](https://github.com/product-on-purpose/pm-skills/blob/main/CHANGELOG.md#2300---2026-07-04) and [`docs/releases/Release_v2.30.0.md`](releases/Release_v2.30.0.md).
