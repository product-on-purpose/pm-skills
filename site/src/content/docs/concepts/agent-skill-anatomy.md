...
└────┬─────┘                    └────┬─────┘
     ...
     ▼                                ▼
┌──────────────────┐           ┌──────────────────┐
│ AI sees 66 skills│           │ AI loads 1 skill │
...
**Current repo note**: `AGENTS.md` registers all 66 skills in `skills/`, including domain, foundation, and utility classifications.
...
**Benefit**: Context-appropriate loading.only the selected skill loads, not all 66 skills
...
- Discovery: ~11KB (65 skill names + descriptions)
- Invocation: ~15KB (1 full SKILL.md + template + example)
- Without progressive loading: ~500KB (all 66 skills fully loaded)
