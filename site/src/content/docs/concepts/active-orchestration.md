...
pm-skills started as a content library: skills that AI agents read at invocation time to produce PM artifacts with professional quality. Through several releases, the catalog grew to 66 skills, 12 workflows, and 27 enforcing CI validators. All of it is content. The AI reads it. The AI acts on it. The AI produces the output.
