...
All 68 skills become available immediately, no clone required. Invoke any skill by name, like `/pm-skills:deliver-prd "Feature description"`. Already installed via the old `pm-skills-marketplace`? It keeps working, no action needed - see [Setup by Platform](platforms.md) to move to the new home.
