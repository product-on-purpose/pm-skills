...
def generate_skill_page(skill_dir: Path) -> dict | None:
    ...
    # was removed in v2.14.x V10 (2026-05-10) because the warning was contributor-noise on
    # the rendered docs site; users do not care how the page is generated. Contributors
    # viewing raw markdown still see the frontmatter; check-generated-content-untouched.sh
    # validator still uses the frontmatter marker.
