# Quick Reference: awesome-product-management PR

## TL;DR

Add PM-Skills to the "Additional resources" section of awesome-product-management README.
...
In `README.md`, add after existing items in the **"Additional resources"** section (near bottom of file, before License section).
...
# Edit README.md - add the entry to Additional resources section
...
- ✅ Not pay-walled (open source)
- ✅ Not advertising (educational resource)
- ✅ Genuinely helpful for PMs
