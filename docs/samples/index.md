---
title: Samples
description: Browse 127 PM artifact samples spanning 64 skills and three product threads (Storevine, Brainshelf, Workbench).
sidebar:
  order: 1
---
...
- **By skill**: expand the **Samples** group in the left sidebar. Each of the 64 skills has its own subgroup with 2-3 samples (one per thread, in most cases).
