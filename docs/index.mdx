---
title: PM Skills
description: 59 AI agent skills for product managers - open-source, spec-compliant, and ready for Claude Code, Cursor, GitHub Copilot, and more. Includes the v2.15.0 Sprint Skills launch (Foundation Sprint + Design Sprint families) and the v2.16.0 Active Orchestration sub-agent dispatch slate.
tags:
  - Home
---
...
**59 best-practice product management skills for AI agents.**
...
<CardGrid>
  <Card title="Discover (3 skills)" icon="magnifier">
    Research, competitive analysis, stakeholder mapping.

    [Browse Discover](skills/discover/)
  </Card>

  <Card title="Define (4 skills)" icon="puzzle">
  ...
  <Card title="Measure (5 skills)" icon="bars">
...
26 domain skills across 6 phases, plus 8 foundation, 10 utility, and 15 tool skills (Foundation Sprint + Design Sprint families + v2.16.0 sub-agent dispatch slate):
