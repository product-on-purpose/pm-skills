---
title: PM Skills
description: 64 AI agent skills for product managers - open-source, spec-compliant, and ready for Claude Code, Cursor, GitHub Copilot, and more. Turn any AI assistant into a PM that ships professional PRDs, user stories, experiment designs, and workshop outputs on demand.
tags:
  - Home
---
...
**64 best-practice product management skills for AI agents.**
...
|---------|------|-----------|
| **[v2.22.0](releases/Release_v2.22.0.md)** | 2026-05-30 | One menu entry per skill: the 63 duplicate command wrappers are gone, so each capability shows once. Native Codex support added via a `.codex-plugin` manifest. All 64 skills unchanged. |
