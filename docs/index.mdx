...
| [v2.10.0](releases/Release_v2.10.0.md) | 2026-04-11 | Utility skill expansion: `utility-mermaid-diagrams`, `utility-slideshow-creator`, `utility-update-pm-skills`. (v2.10.1 and v2.10.2 patches followed; see CHANGELOG.md for details.) |
