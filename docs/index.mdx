---
title: PM Skills
description: 55 AI agent skills for product managers - open-source, spec-compliant, and ready for Claude Code, Cursor, GitHub Copilot, and more. Includes the v2.15.0 Sprint Skills launch (Foundation Sprint + Design Sprint families).
tags:
  - Home
---
...
**55 best-practice product management skills for AI agents.**
...
<CardGrid>
  ...
  <Card title="Utility (6 skills)" icon="pencil">
...
26 domain skills across 6 phases, plus 8 foundation, 6 utility, and 15 tool skills (Foundation Sprint + Design Sprint families):
