...
- Coverage-governance records for the shipped lane live under `docs/internal/release-plans/v2.6.1/`, not local-only working material.
...
- `docs/internal/release-plans/v2.6.1/skill-output-samples_manifest.v2.6.1.json` -- tracked release-governance coverage record
