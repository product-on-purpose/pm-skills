...
| 3 | F-14 | Workflow Builder (`/workflow-builder`) | New skill | Claude | Backlog | — |
| 4 | F-15 | Ad-hoc Skill Chaining (`/chain`) | New feature | Claude | Backlog | — |
| 5 | F-12 | Skill quality convergence | Quality | Claude + Human | Draft | — |
