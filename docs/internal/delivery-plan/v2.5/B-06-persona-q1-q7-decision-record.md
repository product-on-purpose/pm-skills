...
- `docs/internal/delivery-plan/v2.5/B-05-foundation-phase-decision.md` (Q5 dependency, now signed defer)
- `_NOTES/efforts/persona-builder/plan/execution-plan_claude-code.md` (Q1-Q7 framing input)
- `_NOTES/efforts/persona-builder/plan/plan_persona_claude-opus.md` (recommended options and trade-offs)
...
- `docs/internal/delivery-plan/v2.5/B-06-persona-q1-q7-decision-record.md` (this file)
