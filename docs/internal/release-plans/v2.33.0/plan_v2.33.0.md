...
**Status:** **READY TO TAG, 2026-08-29. G2 and G2.5 COMPLETE; the tag target is captured below and the cycle is paused there by maintainer choice.**
...
**Remaining gates:** G3 (tag and push) and G4 (post-tag hygiene, which owns both halves of the release-plans index row and the section C external surfaces). Neither has run.
