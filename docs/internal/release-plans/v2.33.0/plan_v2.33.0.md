...
| C-4 | Front-door discoverability | Raised in three consecutive session wraps, never ruled | S-M | README and QUICKSTART say nothing about hooks or project memory. v2.32.0 ships memory as its headline, which sharpens the gap: the front door does not mention the release's main feature |
