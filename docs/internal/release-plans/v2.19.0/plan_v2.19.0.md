...
**Status:** EXECUTING - **Phase 1 COMPLETE** (FU-1, FU-2, FU-3, FU-5 shipped 2026-05-22; FU-3 also absorbed PR-2's README internal-link sweep). Remaining: Phase 2 (FU-4, FU-6, FU-7, FU-8, FU-9), Phase 3 (PR-1..PR-5), Phase 4 (release).
