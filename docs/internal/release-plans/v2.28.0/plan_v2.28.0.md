...
| utility-pm-critic fixture relabeling | Live trigger-lane finding (`records/router-eval-live-20260615.md`) | `utility-pm-critic` attracts critique-framed prompts the fixtures label for domain skills (deliver-edge-cases, foundation-okr-writer, foundation-persona) - likely mislabeled near-misses; review + re-run. |
