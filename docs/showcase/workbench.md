...
*Workbench Blueprints one-page business thesis anchoring the Q3 expansion-strategy review and feeding the GA PRD plus the expansion pricing memo*
...
!!! quote "Prompt"
    ...
    **Visual-mode companion**: a fully rendered HTML canvas (canonical Maurya layout, print-ready A3 landscape) ships alongside this sample at [`sample_foundation-lean-canvas_workbench_blueprints.html`](https://github.com/product-on-purpose/pm-skills/blob/main/library/skill-output-samples/foundation-lean-canvas/sample_foundation-lean-canvas_workbench_blueprints.html).
