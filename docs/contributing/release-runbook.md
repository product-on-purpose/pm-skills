...
For pre-G3 failures (any gate G0 through G2.5), there is nothing to roll back: the tag has not been created and nothing has been pushed (except potentially the G2.5 commit, which is the release-prep commit and stays).
