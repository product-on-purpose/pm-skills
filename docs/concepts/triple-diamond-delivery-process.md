...
description: "The Triple Diamond product-delivery framework: three diamonds (Problem Space, Solution Space, Learning Space) covering six phases (Discover, Define, Develop, Deliver, Measure, Iterate) that organize the 27 phase-classified pm-skills (of 60 total)."
---
