...
- **Skills remain the bulk of pm-skills.** 63 skills at v2.15.0; still 55 at v2.16.0 (plus 4 dispatch skills, which are thin wrappers, not new content). The content library is the foundation; sub-agents extend its surface.
