...
└────┬─────┘                    └────┬─────┘
     ...
     ▼                                ▼
┌──────────────────┐           ┌──────────────────┐
│ AI sees 32 skills│           │ AI loads 1 skill │
...
**Current repo note**: `AGENTS.md` registers all 32 skills in `skills/`, including domain, foundation, and utility classifications.
...
**Benefit**: Context-appropriate loading—only the selected skill loads, not all 32 skills
...
- Discovery: ~6KB (32 skill names + descriptions)
- Invocation: ~15KB (1 full SKILL.md + template + example)
- Without progressive loading: ~400KB (all 32 skills fully loaded)
