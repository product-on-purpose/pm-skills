...
└────┬─────┘                    └────┬─────┘
     ...
     ▼                                ▼
┌──────────────────┐           ┌──────────────────┐
│ AI sees 60 skills│           │ AI loads 1 skill │
...
**Current repo note**: `AGENTS.md` registers all 60 skills in `skills/`, including domain, foundation, and utility classifications.
...
**Benefit**: Context-appropriate loading.only the selected skill loads, not all 60 skills
...
- Without progressive loading: ~500KB (all 60 skills fully loaded)
