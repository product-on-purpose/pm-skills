...
**Job Title:** [Short name for this job]
**Date:** [When canvas was created]
**Author:** [Who created this]
**Research Basis:** [What research informed this: interviews, surveys, observation, etc.]
...
**Not Defined By:**
<!-- What demographics or attributes are NOT defining factors -->
...
**Functional Pains:**
<!-- What makes this job difficult functionally -->
...
**Emotional Pains:**
<!-- What causes negative emotions in current solutions -->
...
**Social Context:**
<!-- Who else is involved or observing -->
...
**Why Do They Switch?**
<!-- What causes customers to fire one solution and hire another -->

- [Switch trigger 1]
- [Switch trigger 2]

**Why Do They Stay?**
<!-- What keeps customers with current solutions despite problems -->
...
<!-- What tips the decision between options -->
...
- Product Implication: [What to build/change]
...
<details>
<summary>Jobs to be Done Canvas: Weeknight Dinner Decision</summary>

# Jobs to be Done Canvas: Weeknight Dinner Decision

## Job Overview

**Job Title:** Weeknight Dinner Decision
**Date:** January 2026
**Author:** Product Team
**Research Basis:** 12 in-depth interviews with parents who cook 4+ weeknight dinners, observation of 5 dinner prep sessions, 200 survey responses
...
- Works (full-time, part-time, or manages household full-time)
- Cooks dinner at home 4+ times per week
- Feels time pressure between end of workday and dinner time

**Not Defined By:**
- Gender (53% women, 47% men in our research)
- Specific age range
- Cooking skill level (novice to experienced)
- Income level (job exists across economic spectrum)
...
1. Realize dinner decision needs to be made
2. Assess what's available (fridge, pantry, time)
3. Consider constraints (dietary, preferences, energy)
4. Decide on a meal
5. Acquire any missing ingredients (or adjust plan)
6. Prepare the meal
7. Serve and (hopefully) eat together
...
- Product Implication: Pantry tracking and "what can I make with what I have" is more valuable than recipe discovery.

**Key Insight 3:** The emotional weight of this job is underestimated. Parents carry real shame about dinner struggles. Solutions must reduce guilt, not add to it (e.g., "you should be meal planning on Sunday").
- Product Implication: Tone matters. No judgment, celebrate small wins, make "good enough" feel okay.
...
<details>
<summary>Storevine (B2B): Storevine B2B ecommerce platform . merchant email and tool-stack job-to-be-done for Campaigns</summary>
...
<details>
<summary>Brainshelf (Consumer): Brainshelf consumer PKM app . JTBD canvas for saved content re-engagement</summary>
...
<details>
<summary>Workbench (Enterprise): "Workbench enterprise collaboration platform: Blueprints JTBD for ops managers enforcing documentation standards"</summary>
