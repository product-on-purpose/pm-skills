...
<details>
<summary>PRD: Recurring Tasks</summary>
...
<details>
<summary>Storevine (B2B): Storevine B2B ecommerce platform . Campaigns (built-in email marketing)</summary>
...
<details>
<summary>Brainshelf (Consumer): Brainshelf consumer PKM app . Resurface feature PRD for Sprint 8 build</summary>
...
<details>
<summary>Workbench (Enterprise): Workbench enterprise collaboration platform - Blueprints v1 PRD for required-section enforcement and approval gates</summary>
