...
<details>
<summary>Acceptance Criteria: Guest Checkout</summary>
...
<details>
<summary>Storevine (B2B): Storevine B2B ecommerce platform . acceptance criteria for the Campaigns email template builder</summary>
