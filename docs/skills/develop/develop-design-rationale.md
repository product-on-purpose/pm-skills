...
<details>
<summary>Design Rationale: Primary Navigation Pattern for Mobile App</summary>
...
<details>
<summary>Storevine (B2B): Storevine B2B ecommerce platform . Campaigns audience selection UX design decision</summary>
...
<details>
<summary>Brainshelf (Consumer): Brainshelf consumer PKM app . digest email layout design decision for the Resurface feature</summary>
...
<details>
<summary>Workbench (Enterprise): "Workbench enterprise collaboration platform: guided wizard vs. blank canvas for Blueprint creation flow"</summary>
