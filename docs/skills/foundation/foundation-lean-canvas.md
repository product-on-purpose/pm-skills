...
<details>
<summary>Lean Canvas: RestoreAI (Customer Success Copilot for Mid-Market SaaS)</summary>
...
<details>
<summary>Storevine (B2B): Storevine Campaigns lean canvas for framing the built-in email / SMS re-engagement feature as an embedded alternative to Klaviyo for SMB merchants</summary>
...
<details>
<summary>Brainshelf (Consumer): Brainshelf Resurface lean canvas for framing the morning email digest as a retention and referral lever in a consumer PKM app</summary>
...
<details>
<summary>Workbench (Enterprise): Workbench Blueprints lean canvas for framing the required-section doc templates with approval gates as an enterprise expansion motion against Confluence and Notion</summary>
