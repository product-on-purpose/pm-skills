...
<details>
<summary>Skill Implementation Packet: Change Communication</summary>
...
All 64 skills reviewed. Closest matches:
...
<details>
<summary>Storevine (B2B): Storevine B2B ecommerce platform . using the skill builder to create a campaign-analytics skill</summary>
