...
!!! warning "Generated file"
    This page is regenerated by `scripts/generate-skill-pages.py` from the skill catalog and `commands/` directory. Re-run the generator after adding or changing skills or commands.
