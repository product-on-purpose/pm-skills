...
**Content library (the bulk of the repo):** 60 skills, 67 slash commands, 12 workflows, 27 enforcing CI validators. Skills are content - reference material an AI reads at invocation time. They do not execute logic on their own.
