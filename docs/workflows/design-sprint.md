...
**Skill:** [`tool-design-sprint-readiness`](../skills/tool/tool-design-sprint-readiness.md)
...
**Skill:** [`tool-design-sprint-brief`](../skills/tool/tool-design-sprint-brief.md)
...
**Skill:** [`tool-design-sprint-map-and-target`](../skills/tool/tool-design-sprint-map-and-target.md)
...
**Cross-skill:** Invokes [`tool-note-and-vote`](../skills/tool/tool-note-and-vote.md) for HMW heat-map; optionally for target-moment supervote.
...
**Skill:** [`tool-design-sprint-sketch`](../skills/tool/tool-design-sprint-sketch.md)
...
**Skill:** [`tool-design-sprint-decide-and-storyboard`](../skills/tool/tool-design-sprint-decide-and-storyboard.md)
...
**Skill:** [`tool-design-sprint-prototype-plan`](../skills/tool/tool-design-sprint-prototype-plan.md)
...
**Skill:** [`tool-design-sprint-test-and-score`](../skills/tool/tool-design-sprint-test-and-score.md)
...
|---|---|---|
| Build | PRD for v0.1 build | [`deliver-prd`](../skills/deliver/deliver-prd.md) |
| Iterate (refine prototype + re-sprint) | Smaller follow-on experiment design | [`measure-experiment-design`](../skills/measure/measure-experiment-design.md) |
| Pivot (to backup approach) | Pivot rationale + plan | [`iterate-pivot-decision`](../skills/iterate/iterate-pivot-decision.md) |
| Stop | Lessons captured for future strategic work | [`iterate-lessons-log`](../skills/iterate/iterate-lessons-log.md) |
| Stakeholder communication for any of the above | Async update | [`foundation-stakeholder-update`](../skills/foundation/foundation-stakeholder-update.md) |
