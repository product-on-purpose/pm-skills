...
**Status:** **v2.17.0 release-prep STAGED** (2026-05-20) - version bumped to 2.17.0 (plugin.json + marketplace.json + README badge), CHANGELOG v2.17.0 entry + Release_v2.17.0.md written, CONTEXT currency markers bumped. The only remaining step is the `git tag` + GitHub Release (via `/pm-release v2.17.0` or a manual tag). All four work items (W1-W4) + F-P2-01 are complete and CI-green on main. Previous tagged release: **v2.16.2** (2026-05-19, SHIPPED).
