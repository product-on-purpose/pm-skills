...
- **65 PM skills on main** (v2.24.0): 30 phase skills (across 6 Triple Diamond phases) + 9 foundation skills + 11 utility skills + 15 tool-classification entries (Foundation Sprint family of 7 + Design Sprint family of 7 + tool-note-and-vote standalone).
