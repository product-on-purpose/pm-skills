...
- **68 PM skills on main** (catalog stable since v2.29.0): 30 phase skills (across 6 Triple Diamond phases) + 11 foundation skills + 12 utility skills + 15 tool-classification entries (Foundation Sprint family of 7 + Design Sprint family of 7 + tool-note-and-vote standalone).
