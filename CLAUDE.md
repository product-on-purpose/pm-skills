...
- **66 PM skills on main** (v2.27.0 line): 30 phase skills (across 6 Triple Diamond phases) + 9 foundation skills + 12 utility skills + 15 tool-classification entries (Foundation Sprint family of 7 + Design Sprint family of 7 + tool-note-and-vote standalone).
